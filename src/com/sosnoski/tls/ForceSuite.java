...
/**
 * Use a wrapped socket factory to force particular cipher suite(s) for a connection.
 */
public class ForceSuite
{
    /**
     * Connect to a server using particular cipher suite(s). The protocol is controlled by using a wrapper for the
    ...
    public static void main(String[] args) throws IOException, GeneralSecurityException {
        if (args.length == 0) {
            System.out.println("Usage: java com.sosnoski.tls.ForceSuite url");
            System.exit(1);
        }
